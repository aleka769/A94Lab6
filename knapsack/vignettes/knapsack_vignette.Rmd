...
The computational time without the `pause` call is 0.03 seconds. LET'S SAY SOMETHING ABOUT APPROACH HERE. I CAN'T THINK OF  FASTER WAY TO IMPLEMENT THIS!
...
The time demanding calculations from function call above is not suprisingly `intToBits` and `mcLapply`. However, the `profvis` profiling has been done with a windows OS using only one core, thereby computational time can probably be lowered with more cores.
